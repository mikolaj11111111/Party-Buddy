...
- Gry: trivia ABCD + lokalne slice'y gier 5 sekund i wisielec
...
- Baza haseł gry wisielec: `data/hangman/words.json` (hasło + kategoria + trudność + podpowiedź).
...
- **v1** — rozbudowa dodatkowych gier, wybór głosu (2-3 opcje)
